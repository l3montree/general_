#copied from https://beltoforion.de/en/recreational_mathematics/2d-wave-equation.php
"""
used to compare my work and working code
"""
...
def update(u):
    ...
    u[0, 2:dimx-2, 2:dimy-2]  = alpha[2:dimx-2, 2:dimy-2] * ( -  1 * u[1, 2:dimx-2, 0:dimy-4] 
